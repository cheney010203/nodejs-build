...
#define TORQUE_ASSIGNED_INSTANCE_TYPES(V) \
  V(FIRST_HEAP_OBJECT_TYPE, 0) \
    ...
    V(FIRST_FOREIGN_TYPE, 70) \
      V(FOREIGN_TYPE, 70) \
      V(FIRST_WASM_FUNCTION_DATA_TYPE, 71) \
        V(WASM_FUNCTION_DATA_TYPE, 71) \
        V(WASM_CAPI_FUNCTION_DATA_TYPE, 72) \
        V(WASM_EXPORTED_FUNCTION_DATA_TYPE, 73) \
        V(WASM_JS_FUNCTION_DATA_TYPE, 74) \
      V(LAST_WASM_FUNCTION_DATA_TYPE, 74) \
      V(WASM_TYPE_INFO_TYPE, 75) \
    V(LAST_FOREIGN_TYPE, 75) \
    V(FIRST_STRUCT_TYPE, 76) \
      V(FIRST_MICROTASK_TYPE, 76) \
        V(FIRST_PROMISE_REACTION_JOB_TASK_TYPE, 76) \
          V(PROMISE_FULFILL_REACTION_JOB_TASK_TYPE, 76) \
          V(PROMISE_REJECT_REACTION_JOB_TASK_TYPE, 77) \
        V(LAST_PROMISE_REACTION_JOB_TASK_TYPE, 77) \
        V(CALLABLE_TASK_TYPE, 78) \
        V(CALLBACK_TASK_TYPE, 79) \
        V(PROMISE_RESOLVE_THENABLE_JOB_TASK_TYPE, 80) \
      V(LAST_MICROTASK_TYPE, 80) \
      V(FIRST_DATA_HANDLER_TYPE, 81) \
        V(LOAD_HANDLER_TYPE, 81) \
        V(STORE_HANDLER_TYPE, 82) \
      V(LAST_DATA_HANDLER_TYPE, 82) \
      V(FIRST_TEMPLATE_INFO_TYPE, 83) \
        V(FUNCTION_TEMPLATE_INFO_TYPE, 83) \
        V(OBJECT_TEMPLATE_INFO_TYPE, 84) \
      V(LAST_TEMPLATE_INFO_TYPE, 84) \
      V(ACCESS_CHECK_INFO_TYPE, 85) \
      V(ACCESSOR_INFO_TYPE, 86) \
      V(ACCESSOR_PAIR_TYPE, 87) \
      V(ALIASED_ARGUMENTS_ENTRY_TYPE, 88) \
      V(ALLOCATION_MEMENTO_TYPE, 89) \
      V(ALLOCATION_SITE_TYPE, 90) \
      V(ARRAY_BOILERPLATE_DESCRIPTION_TYPE, 91) \
      V(ASM_WASM_DATA_TYPE, 92) \
      V(ASYNC_GENERATOR_REQUEST_TYPE, 93) \
      V(BASELINE_DATA_TYPE, 94) \
      V(BREAK_POINT_TYPE, 95) \
      V(BREAK_POINT_INFO_TYPE, 96) \
      V(CACHED_TEMPLATE_OBJECT_TYPE, 97) \
      V(CALL_HANDLER_INFO_TYPE, 98) \
      V(CLASS_POSITIONS_TYPE, 99) \
      V(DEBUG_INFO_TYPE, 100) \
      V(ENUM_CACHE_TYPE, 101) \
      V(FEEDBACK_CELL_TYPE, 102) \
      V(FUNCTION_TEMPLATE_RARE_DATA_TYPE, 103) \
      V(INTERCEPTOR_INFO_TYPE, 104) \
      V(INTERPRETER_DATA_TYPE, 105) \
      V(MODULE_REQUEST_TYPE, 106) \
      V(PROMISE_CAPABILITY_TYPE, 107) \
      V(PROMISE_REACTION_TYPE, 108) \
      V(PROPERTY_DESCRIPTOR_OBJECT_TYPE, 109) \
      V(PROTOTYPE_INFO_TYPE, 110) \
      V(REG_EXP_BOILERPLATE_DESCRIPTION_TYPE, 111) \
      V(SCRIPT_TYPE, 112) \
      V(SOURCE_TEXT_MODULE_INFO_ENTRY_TYPE, 113) \
      V(STACK_FRAME_INFO_TYPE, 114) \
      V(TEMPLATE_OBJECT_DESCRIPTION_TYPE, 115) \
      V(TUPLE2_TYPE, 116) \
      V(WASM_EXCEPTION_TAG_TYPE, 117) \
      V(WASM_INDIRECT_FUNCTION_TABLE_TYPE, 118) \
    V(LAST_STRUCT_TYPE, 118) \
    V(FIRST_FIXED_ARRAY_BASE_TYPE, 119) \
      V(FIRST_FIXED_ARRAY_TYPE, 119) \
        V(FIXED_ARRAY_TYPE, 119) \
        V(FIRST_HASH_TABLE_TYPE, 120) \
          V(HASH_TABLE_TYPE, 120) \
          V(EPHEMERON_HASH_TABLE_TYPE, 121) \
          V(GLOBAL_DICTIONARY_TYPE, 122) \
          V(NAME_DICTIONARY_TYPE, 123) \
          V(NUMBER_DICTIONARY_TYPE, 124) \
          V(ORDERED_HASH_MAP_TYPE, 125) \
          V(ORDERED_HASH_SET_TYPE, 126) \
          V(ORDERED_NAME_DICTIONARY_TYPE, 127) \
          V(SIMPLE_NUMBER_DICTIONARY_TYPE, 128) \
      ...
      V(SLOPPY_ARGUMENTS_ELEMENTS_TYPE, 136) \
    V(LAST_FIXED_ARRAY_BASE_TYPE, 136) \
    V(FIRST_CONTEXT_TYPE, 137) \
      V(AWAIT_CONTEXT_TYPE, 137) \
      V(BLOCK_CONTEXT_TYPE, 138) \
      V(CATCH_CONTEXT_TYPE, 139) \
      V(DEBUG_EVALUATE_CONTEXT_TYPE, 140) \
      V(EVAL_CONTEXT_TYPE, 141) \
      V(FUNCTION_CONTEXT_TYPE, 142) \
      V(MODULE_CONTEXT_TYPE, 143) \
      V(NATIVE_CONTEXT_TYPE, 144) \
      V(SCRIPT_CONTEXT_TYPE, 145) \
      V(WITH_CONTEXT_TYPE, 146) \
    V(LAST_CONTEXT_TYPE, 146) \
    V(FIRST_EXPORTED_SUB_CLASS_BASE_TYPE, 147) \
      V(EXPORTED_SUB_CLASS_BASE_TYPE, 147) \
      V(EXPORTED_SUB_CLASS_TYPE, 148) \
      V(EXPORTED_SUB_CLASS2_TYPE, 149) \
    V(LAST_EXPORTED_SUB_CLASS_BASE_TYPE, 149) \
    V(FIRST_SMALL_ORDERED_HASH_TABLE_TYPE, 150) \
      V(SMALL_ORDERED_HASH_MAP_TYPE, 150) \
      V(SMALL_ORDERED_HASH_SET_TYPE, 151) \
      V(SMALL_ORDERED_NAME_DICTIONARY_TYPE, 152) \
    V(LAST_SMALL_ORDERED_HASH_TABLE_TYPE, 152) \
    V(FIRST_DESCRIPTOR_ARRAY_TYPE, 153) \
      V(DESCRIPTOR_ARRAY_TYPE, 153) \
      V(STRONG_DESCRIPTOR_ARRAY_TYPE, 154) \
    V(LAST_DESCRIPTOR_ARRAY_TYPE, 154) \
    V(FIRST_MODULE_TYPE, 155) \
      V(SOURCE_TEXT_MODULE_TYPE, 155) \
      V(SYNTHETIC_MODULE_TYPE, 156) \
    V(LAST_MODULE_TYPE, 156) \
    V(FIRST_UNCOMPILED_DATA_TYPE, 157) \
      V(UNCOMPILED_DATA_WITH_PREPARSE_DATA_TYPE, 157) \
      V(UNCOMPILED_DATA_WITHOUT_PREPARSE_DATA_TYPE, 158) \
    V(LAST_UNCOMPILED_DATA_TYPE, 158) \
    V(FIRST_WEAK_FIXED_ARRAY_TYPE, 159) \
      V(WEAK_FIXED_ARRAY_TYPE, 159) \
      V(TRANSITION_ARRAY_TYPE, 160) \
    V(LAST_WEAK_FIXED_ARRAY_TYPE, 160) \
    V(CELL_TYPE, 161) \
    V(CODE_TYPE, 162) \
    V(CODE_DATA_CONTAINER_TYPE, 163) \
    V(COVERAGE_INFO_TYPE, 164) \
    V(EMBEDDER_DATA_ARRAY_TYPE, 165) \
    V(FEEDBACK_METADATA_TYPE, 166) \
    V(FEEDBACK_VECTOR_TYPE, 167) \
    V(FILLER_TYPE, 168) \
    V(FREE_SPACE_TYPE, 169) \
    V(INTERNAL_CLASS_TYPE, 170) \
    V(INTERNAL_CLASS_WITH_STRUCT_ELEMENTS_TYPE, 171) \
    V(MAP_TYPE, 172) \
    V(MEGA_DOM_HANDLER_TYPE, 173) \
    V(ON_HEAP_BASIC_BLOCK_PROFILER_DATA_TYPE, 174) \
    V(PREPARSE_DATA_TYPE, 175) \
    V(PROPERTY_ARRAY_TYPE, 176) \
    V(PROPERTY_CELL_TYPE, 177) \
    V(SCOPE_INFO_TYPE, 178) \
    V(SHARED_FUNCTION_INFO_TYPE, 179) \
    V(SMI_BOX_TYPE, 180) \
    V(SMI_PAIR_TYPE, 181) \
    V(SORT_STATE_TYPE, 182) \
    V(SWISS_NAME_DICTIONARY_TYPE, 183) \
    V(WEAK_ARRAY_LIST_TYPE, 184) \
    V(WEAK_CELL_TYPE, 185) \
    V(FIRST_JS_RECEIVER_TYPE, 186) \
      V(FIRST_WASM_OBJECT_TYPE, 186) \
        V(WASM_ARRAY_TYPE, 186) \
        V(WASM_STRUCT_TYPE, 187) \
      V(LAST_WASM_OBJECT_TYPE, 187) \
      V(JS_PROXY_TYPE, 188) \
      V(FIRST_JS_OBJECT_TYPE, 189) \
        V(JS_OBJECT_TYPE, 1057) \
        V(FIRST_JS_CUSTOM_ELEMENTS_OBJECT_TYPE, 189) \
          V(FIRST_JS_SPECIAL_OBJECT_TYPE, 189) \
            V(JS_GLOBAL_OBJECT_TYPE, 189) \
            V(JS_GLOBAL_PROXY_TYPE, 190) \
            V(JS_MODULE_NAMESPACE_TYPE, 191) \
        ...
        V(WASM_GLOBAL_OBJECT_TYPE, 1099) \
        V(WASM_INSTANCE_OBJECT_TYPE, 1100) \
        V(WASM_MEMORY_OBJECT_TYPE, 1101) \
        V(WASM_MODULE_OBJECT_TYPE, 1102) \
        V(WASM_TABLE_OBJECT_TYPE, 1103) \
        V(WASM_TAG_OBJECT_TYPE, 1104) \
        V(WASM_VALUE_OBJECT_TYPE, 1105) \
      V(LAST_JS_OBJECT_TYPE, 1105) \
    V(LAST_JS_RECEIVER_TYPE, 1105) \
  V(LAST_HEAP_OBJECT_TYPE, 1105) \
...
#define TORQUE_ASSIGNED_INSTANCE_TYPE_LIST(V) \
  ...
  V(WASM_TAG_OBJECT_TYPE) \
  V(WASM_VALUE_OBJECT_TYPE) \
...
#define TORQUE_INSTANCE_CHECKERS_SINGLE_ONLY_DECLARED(V) \
  ...
  V(WasmValueObject, WASM_VALUE_OBJECT_TYPE) \
