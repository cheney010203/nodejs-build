...
USE(parameter1);
  ...
  if (block15.is_used()) {
    ...
    tmp10 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtin::kArraySomeLoopContinuation), parameter0, tmp0, tmp2, parameter3, tmp8, tmp0, tmp4, tmp6, tmp9);
...
USE(parameter1);
  ...
  if (block18.is_used()) {
    ...
    tmp14 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtin::kArraySomeLoopContinuation), parameter0, tmp0, tmp2, parameter3, tmp12, tmp0, tmp11, tmp6, tmp13);
...
TNode<Object> FastArraySome_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_o, TNode<Number> p_len, TNode<JSReceiver> p_callbackfn, TNode<Object> p_thisArg, compiler::CodeAssemblerLabel* label_Bailout, compiler::TypedCodeAssemblerVariable<Smi>* label_Bailout_parameter_0) {
  ...
  if (block27.is_used()) {
    ...
    ca_.Branch(tmp24, &block36, std::vector<compiler::Node*>{phi_bb27_5}, &block37, std::vector<compiler::Node*>{phi_bb27_5});
  }
...
USE(parameter1);
  ...
  if (block10.is_used()) {
    ...
    tmp16 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtin::kArraySomeLoopContinuation), parameter0, tmp1, tmp7, tmp10, tmp14, tmp1, tmp13.value(), tmp2, tmp15);
