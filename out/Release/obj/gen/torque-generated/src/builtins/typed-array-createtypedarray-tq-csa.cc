...
TNode<JSTypedArray> AllocateTypedArray_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, bool p_isOnHeap, TNode<Map> p_map, TNode<JSArrayBuffer> p_buffer, TNode<UintPtrT> p_byteOffset, TNode<UintPtrT> p_byteLength, TNode<UintPtrT> p_length, TNode<BoolT> p_isLengthTracking) {
  ...
  if (block4.is_used()) {
    ...
    tmp11 = FromConstexpr_intptr_constexpr_int31_0(state_, 72);
...
TNode<JSTypedArray> ConstructByArrayLike_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Map> p_map, TNode<HeapObject> p_arrayLike, TNode<UintPtrT> p_length, TorqueStructTypedArrayElementsInfo p_elementsInfo, TNode<JSReceiver> p_bufferConstructor) {
  ...
  if (block15.is_used()) {
    ca_.Bind(&block15);
    tmp10 = CodeStubAssembler(state_).LoadElementsKind(TNode<JSTypedArray>{tmp3});
    tmp11 = TypedArrayBuiltinsAssembler(state_).IsBigInt64ElementsKind(TNode<Int32T>{tmp10});
    tmp12 = TypedArrayBuiltinsAssembler(state_).IsBigInt64ElementsKind(TNode<Int32T>{p_elementsInfo.kind});
    tmp13 = CodeStubAssembler(state_).Word32NotEqual(TNode<BoolT>{tmp11}, TNode<BoolT>{tmp12});
  ...
  if (block16.is_used()) {
    ...
    tmp15 = CodeStubAssembler(state_).UintPtrGreaterThan(TNode<UintPtrT>{p_length}, TNode<UintPtrT>{tmp14});
  ...
  if (block18.is_used()) {
    ...
    tmp17 = CodeStubAssembler(state_).LoadReference<UintPtrT>(CodeStubAssembler::Reference{tmp0, tmp16});
    tmp18 = FromConstexpr_intptr_constexpr_int31_0(state_, 24);
    tmp19 = CodeStubAssembler(state_).LoadReference<JSArrayBuffer>(CodeStubAssembler::Reference{tmp3, tmp18});
    tmp20 = IsSharedArrayBuffer_0(state_, TNode<JSArrayBuffer>{tmp19});
  ...
  if (block24.is_used()) {
    ca_.Bind(&block24);
    tmp21 = CodeStubAssembler(state_).LoadJSTypedArrayDataPtr(TNode<JSTypedArray>{tmp0});
    tmp22 = CodeStubAssembler(state_).LoadJSTypedArrayDataPtr(TNode<JSTypedArray>{tmp3});
    TypedArrayBuiltinsAssembler(state_).CallCRelaxedMemcpy(TNode<RawPtrT>{tmp21}, TNode<RawPtrT>{tmp22}, TNode<UintPtrT>{tmp17});
    ca_.Goto(&block26);
  }
  ...
  if (block25.is_used()) {
    ca_.Bind(&block25);
    tmp23 = CodeStubAssembler(state_).LoadJSTypedArrayDataPtr(TNode<JSTypedArray>{tmp0});
    tmp24 = CodeStubAssembler(state_).LoadJSTypedArrayDataPtr(TNode<JSTypedArray>{tmp3});
    TypedArrayBuiltinsAssembler(state_).CallCMemcpy(TNode<RawPtrT>{tmp23}, TNode<RawPtrT>{tmp24}, TNode<UintPtrT>{tmp17});
    ca_.Goto(&block26);
  }
  ...
  if (block7.is_used()) {
    ...
    tmp26 = CodeStubAssembler(state_).UintPtrGreaterThan(TNode<UintPtrT>{p_length}, TNode<UintPtrT>{tmp25});
  ...
  if (block29.is_used()) {
    ca_.Bind(&block29);
    tmp27 = Convert_Number_uintptr_0(state_, TNode<UintPtrT>{p_length});
    CodeStubAssembler(state_).CallRuntime(Runtime::kTypedArrayCopyElements, p_context, tmp0, p_arrayLike, tmp27);
    ca_.Goto(&block30);
  }
...
TNode<JSTypedArray> TypedArrayCreateByLength_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_constructor, TNode<Number> p_length, const char* p_methodName) {
  ...
  if (block0.is_used()) {
    ...
    tmp2 = FromConstexpr_intptr_constexpr_int31_0(state_, 72);
    ...
    tmp6 = FromConstexpr_intptr_constexpr_int31_0(state_, 72);
