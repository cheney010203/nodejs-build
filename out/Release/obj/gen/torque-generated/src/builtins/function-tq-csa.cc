...
USE(parameter3);
  ...
  if (block23.is_used()) {
    ...
    tmp48 = FromConstexpr_intptr_constexpr_int31_0(state_, 48);
    ...
    tmp54 = FromConstexpr_intptr_constexpr_int31_0(state_, 32);
    CodeStubAssembler(state_).StoreReference<Object>(CodeStubAssembler::Reference{tmp49, tmp54}, tmp44);
    tmp55 = FromConstexpr_intptr_constexpr_int31_0(state_, 40);
