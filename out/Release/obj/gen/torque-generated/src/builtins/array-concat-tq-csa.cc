...
USE(parameter1);
  ...
  if (block15.is_used()) {
    ...
    ca_.Branch(phi_bb15_7, &block11, std::vector<compiler::Node*>{}, &block12, std::vector<compiler::Node*>{});
  }
  ...
  if (block7.is_used()) {
    ...
    tmp18 = Convert_int32_intptr_0(state_, TNode<IntPtrT>{torque_arguments.length});
