...
TNode<Uint32T> TorqueGeneratedExportedMacrosAssembler::LoadJSTypedArrayOptionalPadding(TNode<JSTypedArray> p_o) {
return LoadJSTypedArrayOptionalPadding_0(state_, p_o);}

void TorqueGeneratedExportedMacrosAssembler::StoreJSTypedArrayOptionalPadding(TNode<JSTypedArray> p_o, TNode<Uint32T> p_v) {
return StoreJSTypedArrayOptionalPadding_0(state_, p_o, p_v);}
...
TNode<Int8T> TorqueGeneratedExportedMacrosAssembler::LoadBytecodeArrayOsrLoopNestingLevel(TNode<BytecodeArray> p_o) {
return LoadBytecodeArrayOsrLoopNestingLevel_0(state_, p_o);}

void TorqueGeneratedExportedMacrosAssembler::StoreBytecodeArrayOsrLoopNestingLevel(TNode<BytecodeArray> p_o, TNode<Int8T> p_v) {
return StoreBytecodeArrayOsrLoopNestingLevel_0(state_, p_o, p_v);}
...
TNode<HeapObject> TorqueGeneratedExportedMacrosAssembler::LoadWasmFunctionDataRef(TNode<WasmFunctionData> p_o) {
return LoadWasmFunctionDataRef_0(state_, p_o);}

void TorqueGeneratedExportedMacrosAssembler::StoreWasmFunctionDataRef(TNode<WasmFunctionData> p_o, TNode<HeapObject> p_v) {
return StoreWasmFunctionDataRef_0(state_, p_o, p_v);}
...
TNode<Code> TorqueGeneratedExportedMacrosAssembler::LoadWasmJSFunctionDataWasmToJsWrapperCode(TNode<WasmJSFunctionData> p_o) {
return LoadWasmJSFunctionDataWasmToJsWrapperCode_0(state_, p_o);}

void TorqueGeneratedExportedMacrosAssembler::StoreWasmJSFunctionDataWasmToJsWrapperCode(TNode<WasmJSFunctionData> p_o, TNode<Code> p_v) {
return StoreWasmJSFunctionDataWasmToJsWrapperCode_0(state_, p_o, p_v);}
...
TNode<Uint32T> TorqueGeneratedExportedMacrosAssembler::LoadWasmIndirectFunctionTableOptionalPadding(TNode<WasmIndirectFunctionTable> p_o) {
return LoadWasmIndirectFunctionTableOptionalPadding_0(state_, p_o);}

void TorqueGeneratedExportedMacrosAssembler::StoreWasmIndirectFunctionTableOptionalPadding(TNode<WasmIndirectFunctionTable> p_o, TNode<Uint32T> p_v) {
return StoreWasmIndirectFunctionTableOptionalPadding_0(state_, p_o, p_v);}
