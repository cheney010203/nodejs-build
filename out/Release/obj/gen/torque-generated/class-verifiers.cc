...
void TorqueGeneratedClassVerifiers::SymbolVerify(Symbol o, Isolate* isolate) {
  ...
  CHECK(o.IsSymbol());
  {
    ...
    CHECK(description__value.IsUndefined() || description__value.IsString());
  }
}
...
void TorqueGeneratedClassVerifiers::JSBoundFunctionVerify(JSBoundFunction o, Isolate* isolate) {
  ...
  }
  {
    ...
    CHECK(bound_this__value.IsJSReceiver() || bound_this__value.IsUndefined() || bound_this__value.IsNull() || bound_this__value.IsFalse() || bound_this__value.IsTrue() || bound_this__value.IsSymbol() || bound_this__value.IsString() || bound_this__value.IsBigInt() || bound_this__value.IsHeapNumber() || bound_this__value.IsSmi() || bound_this__value.IsSourceTextModule());
  }
  {
...
void TorqueGeneratedClassVerifiers::WeakCellVerify(WeakCell o, Isolate* isolate) {
  ...
  }
  {
    ...
    CHECK(holdings__value.IsJSReceiver() || holdings__value.IsUndefined() || holdings__value.IsNull() || holdings__value.IsFalse() || holdings__value.IsTrue() || holdings__value.IsSymbol() || holdings__value.IsString() || holdings__value.IsBigInt() || holdings__value.IsHeapNumber() || holdings__value.IsSmi());
  }
  {
...
void TorqueGeneratedClassVerifiers::JSPromiseVerify(JSPromise o, Isolate* isolate) {
  ...
  CHECK(o.IsJSPromise());
  {
    ...
    CHECK(reactions_or_result__value.IsJSReceiver() || reactions_or_result__value.IsUndefined() || reactions_or_result__value.IsNull() || reactions_or_result__value.IsFalse() || reactions_or_result__value.IsTrue() || reactions_or_result__value.IsSymbol() || reactions_or_result__value.IsString() || reactions_or_result__value.IsBigInt() || reactions_or_result__value.IsHeapNumber() || reactions_or_result__value.IsSmi() || reactions_or_result__value.IsPromiseReaction());
  }
  {
...
void TorqueGeneratedClassVerifiers::JSTypedArrayVerify(JSTypedArray o, Isolate* isolate) {
  ...
  {
    Object base_pointer__value = TaggedField<Object>::load(o, 64);
...
void TorqueGeneratedClassVerifiers::CallHandlerInfoVerify(CallHandlerInfo o, Isolate* isolate) {
  ...
  {
    Object js_callback__value = TaggedField<Object>::load(o, 16);
...
void TorqueGeneratedClassVerifiers::AccessorInfoVerify(AccessorInfo o, Isolate* isolate) {
  ...
  {
    Object expected_receiver_type__value = TaggedField<Object>::load(o, 24);
    Object::VerifyPointer(isolate, expected_receiver_type__value);
  }
  {
    Object setter__value = TaggedField<Object>::load(o, 32);
    Object::VerifyPointer(isolate, setter__value);
    CHECK(setter__value.IsZero() || setter__value.IsNonNullForeign());
  }
  {
    Object getter__value = TaggedField<Object>::load(o, 40);
    Object::VerifyPointer(isolate, getter__value);
    CHECK(getter__value.IsZero() || getter__value.IsNonNullForeign());
  }
  {
    Object js_getter__value = TaggedField<Object>::load(o, 48);
...
void TorqueGeneratedClassVerifiers::ScopeInfoVerify(ScopeInfo o, Isolate* isolate) {
  ...
  for (int i = 0; i < static_cast<int>(inferred_function_name__length); ++i) {
    ...
    CHECK(inferred_function_name__value.IsUndefined() || inferred_function_name__value.IsString());
  }
...
void TorqueGeneratedClassVerifiers::DescriptorArrayVerify(DescriptorArray o, Isolate* isolate) {
  ...
  for (int i = 0; i < static_cast<int>(descriptors__length); ++i) {
    ...
    CHECK(key__value.IsUndefined() || key__value.IsName());
    ...
    CHECK(details__value.IsUndefined() || details__value.IsSmi());
...
void TorqueGeneratedClassVerifiers::FeedbackVectorVerify(FeedbackVector o, Isolate* isolate) {
  ...
  {
    MaybeObject maybe_optimized_code__value = TaggedField<MaybeObject>::load(o, 32);
  ...
  {
    Object closure_feedback_cell_array__value = TaggedField<Object>::load(o, 40);
...
void TorqueGeneratedClassVerifiers::JSGeneratorObjectVerify(JSGeneratorObject o, Isolate* isolate) {
  ...
  }
  {
    ...
    CHECK(receiver__value.IsJSReceiver() || receiver__value.IsUndefined() || receiver__value.IsNull() || receiver__value.IsFalse() || receiver__value.IsTrue() || receiver__value.IsSymbol() || receiver__value.IsString() || receiver__value.IsBigInt() || receiver__value.IsHeapNumber() || receiver__value.IsSmi());
  }
  {
...
void TorqueGeneratedClassVerifiers::JSPrimitiveWrapperVerify(JSPrimitiveWrapper o, Isolate* isolate) {
  ...
  CHECK(o.IsJSPrimitiveWrapper());
  {
    Object value__value = TaggedField<Object>::load(o, 24);
    Object::VerifyPointer(isolate, value__value);
    CHECK(value__value.IsJSReceiver() || value__value.IsUndefined() || value__value.IsNull() || value__value.IsFalse() || value__value.IsTrue() || value__value.IsSymbol() || value__value.IsString() || value__value.IsBigInt() || value__value.IsHeapNumber() || value__value.IsSmi());
  }
}
void TorqueGeneratedClassVerifiers::JSMessageObjectVerify(JSMessageObject o, Isolate* isolate) {
  ...
  {
    Object arguments__value = TaggedField<Object>::load(o, 32);
    Object::VerifyPointer(isolate, arguments__value);
  }
  {
...
void TorqueGeneratedClassVerifiers::JSFinalizationRegistryVerify(JSFinalizationRegistry o, Isolate* isolate) {
  ...
  }
  {
    ...
    CHECK(cleanup__value.IsCallableApiObject() || cleanup__value.IsCallableJSProxy() || cleanup__value.IsJSBoundFunction() || cleanup__value.IsJSFunction());
  }
  {
...
void TorqueGeneratedClassVerifiers::SmallOrderedHashSetVerify(SmallOrderedHashSet o, Isolate* isolate) {
  ...
  for (int i = 0; i < static_cast<int>(data_table__length); ++i) {
    ...
    CHECK(data_table__value.IsJSReceiver() || data_table__value.IsUndefined() || data_table__value.IsNull() || data_table__value.IsFalse() || data_table__value.IsTrue() || data_table__value.IsSymbol() || data_table__value.IsString() || data_table__value.IsBigInt() || data_table__value.IsHeapNumber() || data_table__value.IsSmi() || data_table__value.IsTheHole());
  }
}
void TorqueGeneratedClassVerifiers::SmallOrderedHashMapVerify(SmallOrderedHashMap o, Isolate* isolate) {
  ...
  CHECK_EQ(data_table__length, static_cast<int>(data_table__length));
  for (int i = 0; i < static_cast<int>(data_table__length); ++i) {
    Object key__value = TaggedField<Object>::load(o, static_cast<int>(data_table__offset) + 0 + i * 16);
    Object::VerifyPointer(isolate, key__value);
    CHECK(key__value.IsJSReceiver() || key__value.IsUndefined() || key__value.IsNull() || key__value.IsFalse() || key__value.IsTrue() || key__value.IsSymbol() || key__value.IsString() || key__value.IsBigInt() || key__value.IsHeapNumber() || key__value.IsSmi() || key__value.IsTheHole());
    Object value__value = TaggedField<Object>::load(o, static_cast<int>(data_table__offset) + 8 + i * 16);
    Object::VerifyPointer(isolate, value__value);
    CHECK(value__value.IsJSReceiver() || value__value.IsUndefined() || value__value.IsNull() || value__value.IsFalse() || value__value.IsTrue() || value__value.IsSymbol() || value__value.IsString() || value__value.IsBigInt() || value__value.IsHeapNumber() || value__value.IsSmi() || value__value.IsTheHole());
  }
}
void TorqueGeneratedClassVerifiers::SmallOrderedNameDictionaryVerify(SmallOrderedNameDictionary o, Isolate* isolate) {
  ...
  CHECK_EQ(data_table__length, static_cast<int>(data_table__length));
  for (int i = 0; i < static_cast<int>(data_table__length); ++i) {
    Object key__value = TaggedField<Object>::load(o, static_cast<int>(data_table__offset) + 0 + i * 24);
    Object::VerifyPointer(isolate, key__value);
    CHECK(key__value.IsJSReceiver() || key__value.IsUndefined() || key__value.IsNull() || key__value.IsFalse() || key__value.IsTrue() || key__value.IsSymbol() || key__value.IsString() || key__value.IsBigInt() || key__value.IsHeapNumber() || key__value.IsSmi() || key__value.IsTheHole());
    Object value__value = TaggedField<Object>::load(o, static_cast<int>(data_table__offset) + 8 + i * 24);
    Object::VerifyPointer(isolate, value__value);
    CHECK(value__value.IsJSReceiver() || value__value.IsUndefined() || value__value.IsNull() || value__value.IsFalse() || value__value.IsTrue() || value__value.IsSymbol() || value__value.IsString() || value__value.IsBigInt() || value__value.IsHeapNumber() || value__value.IsSmi() || value__value.IsTheHole());
    Object property_details__value = TaggedField<Object>::load(o, static_cast<int>(data_table__offset) + 16 + i * 24);
...
void TorqueGeneratedClassVerifiers::PromiseReactionVerify(PromiseReaction o, Isolate* isolate) {
  ...
  }
  {
    ...
    CHECK(reject_handler__value.IsUndefined() || reject_handler__value.IsCallableApiObject() || reject_handler__value.IsCallableJSProxy() || reject_handler__value.IsJSBoundFunction() || reject_handler__value.IsJSFunction());
  }
  {
    Object fulfill_handler__value = TaggedField<Object>::load(o, 24);
    Object::VerifyPointer(isolate, fulfill_handler__value);
    CHECK(fulfill_handler__value.IsUndefined() || fulfill_handler__value.IsCallableApiObject() || fulfill_handler__value.IsCallableJSProxy() || fulfill_handler__value.IsJSBoundFunction() || fulfill_handler__value.IsJSFunction());
  }
  {
...
void TorqueGeneratedClassVerifiers::PromiseReactionJobTaskVerify(PromiseReactionJobTask o, Isolate* isolate) {
  ...
  }
  {
    Object handler__value = TaggedField<Object>::load(o, 24);
    Object::VerifyPointer(isolate, handler__value);
    CHECK(handler__value.IsUndefined() || handler__value.IsCallableApiObject() || handler__value.IsCallableJSProxy() || handler__value.IsJSBoundFunction() || handler__value.IsJSFunction());
  }
  {
    Object promise_or_capability__value = TaggedField<Object>::load(o, 32);
    Object::VerifyPointer(isolate, promise_or_capability__value);
...
void TorqueGeneratedClassVerifiers::PropertyDescriptorObjectVerify(PropertyDescriptorObject o, Isolate* isolate) {
  ...
  }
  {
    ...
    CHECK(get__value.IsJSReceiver() || get__value.IsUndefined() || get__value.IsNull() || get__value.IsFalse() || get__value.IsTrue() || get__value.IsSymbol() || get__value.IsString() || get__value.IsBigInt() || get__value.IsHeapNumber() || get__value.IsSmi() || get__value.IsTheHole());
  }
  {
    Object set__value = TaggedField<Object>::load(o, 32);
    Object::VerifyPointer(isolate, set__value);
    CHECK(set__value.IsJSReceiver() || set__value.IsUndefined() || set__value.IsNull() || set__value.IsFalse() || set__value.IsTrue() || set__value.IsSymbol() || set__value.IsString() || set__value.IsBigInt() || set__value.IsHeapNumber() || set__value.IsSmi() || set__value.IsTheHole());
  }
}
void TorqueGeneratedClassVerifiers::PrototypeInfoVerify(PrototypeInfo o, Isolate* isolate) {
  ...
  {
    MaybeObject object_create_map__value = TaggedField<MaybeObject>::load(o, 40);
  ...
  {
    Object bit_field__value = TaggedField<Object>::load(o, 48);
...
void TorqueGeneratedClassVerifiers::ScriptVerify(Script o, Isolate* isolate) {
  ...
  }
  {
    ...
    CHECK(context_data__value.IsUndefined() || context_data__value.IsSymbol() || context_data__value.IsSmi());
  }
  {
  ...
  }
  {
    ...
    CHECK(source_url__value.IsUndefined() || source_url__value.IsString());
  }
  {
...
void TorqueGeneratedClassVerifiers::BaselineDataVerify(BaselineData o, Isolate* isolate) {
  ...
  {
    Object baseline_code__value = TaggedField<Object>::load(o, 8);
...
void TorqueGeneratedClassVerifiers::OnHeapBasicBlockProfilerDataVerify(OnHeapBasicBlockProfilerData o, Isolate* isolate) {
  ...
  {
    Object name__value = TaggedField<Object>::load(o, 24);
    Object::VerifyPointer(isolate, name__value);
    CHECK(name__value.IsString());
  }
  {
    Object schedule__value = TaggedField<Object>::load(o, 32);
    Object::VerifyPointer(isolate, schedule__value);
    CHECK(schedule__value.IsString());
  }
  {
    Object code__value = TaggedField<Object>::load(o, 40);
    Object::VerifyPointer(isolate, code__value);
    CHECK(code__value.IsString());
  }
  {
    Object hash__value = TaggedField<Object>::load(o, 48);
    Object::VerifyPointer(isolate, hash__value);
    CHECK(hash__value.IsSmi());
  }
}
...
void TorqueGeneratedClassVerifiers::StackFrameInfoVerify(StackFrameInfo o, Isolate* isolate) {
  ...
  CHECK(o.IsStackFrameInfo());
  {
    ...
    CHECK(receiver_or_instance__value.IsJSReceiver() || receiver_or_instance__value.IsUndefined() || receiver_or_instance__value.IsNull() || receiver_or_instance__value.IsFalse() || receiver_or_instance__value.IsTrue() || receiver_or_instance__value.IsSymbol() || receiver_or_instance__value.IsString() || receiver_or_instance__value.IsBigInt() || receiver_or_instance__value.IsHeapNumber() || receiver_or_instance__value.IsSmi());
  }
  {
...
void TorqueGeneratedClassVerifiers::CachedTemplateObjectVerify(CachedTemplateObject o, Isolate* isolate) {
  ...
  {
    Object slot_id__value = TaggedField<Object>::load(o, 8);
    Object::VerifyPointer(isolate, slot_id__value);
    CHECK(slot_id__value.IsSmi());
  }
  {
    Object template_object__value = TaggedField<Object>::load(o, 16);
...
void TorqueGeneratedClassVerifiers::FunctionTemplateInfoVerify(FunctionTemplateInfo o, Isolate* isolate) {
  ...
  }
  {
    ...
    CHECK(class_name__value.IsUndefined() || class_name__value.IsString());
  }
  {
...
void TorqueGeneratedClassVerifiers::SortStateVerify(SortState o, Isolate* isolate) {
  ...
  }
  {
    ...
    CHECK(userCmpFn__value.IsUndefined() || userCmpFn__value.IsCallableApiObject() || userCmpFn__value.IsCallableJSProxy() || userCmpFn__value.IsJSBoundFunction() || userCmpFn__value.IsJSFunction());
  }
  {
...
void TorqueGeneratedClassVerifiers::WasmFunctionDataVerify(WasmFunctionData o, Isolate* isolate) {
  ...
  CHECK(o.IsWasmFunctionData());
  {
    Object ref__value = TaggedField<Object>::load(o, 16);
    Object::VerifyPointer(isolate, ref__value);
    CHECK(ref__value.IsTuple2() || ref__value.IsWasmInstanceObject());
  }
  {
    Object wrapper_code__value = TaggedField<Object>::load(o, 24);
...
void TorqueGeneratedClassVerifiers::WasmExportedFunctionDataVerify(WasmExportedFunctionData o, Isolate* isolate) {
  ...
  {
    Object signature__value = TaggedField<Object>::load(o, 48);
    Object::VerifyPointer(isolate, signature__value);
    CHECK(signature__value.IsForeign());
  }
  {
    Object wrapper_budget__value = TaggedField<Object>::load(o, 56);
    Object::VerifyPointer(isolate, wrapper_budget__value);
    CHECK(wrapper_budget__value.IsSmi());
  }
  {
    Object c_wrapper_code__value = TaggedField<Object>::load(o, 64);
    Object::VerifyPointer(isolate, c_wrapper_code__value);
    CHECK(c_wrapper_code__value.IsCode());
  }
  {
    Object packed_args_size__value = TaggedField<Object>::load(o, 72);
...
void TorqueGeneratedClassVerifiers::WasmJSFunctionDataVerify(WasmJSFunctionData o, Isolate* isolate) {
  ...
  {
    Object wasm_to_js_wrapper_code__value = TaggedField<Object>::load(o, 32);
    Object::VerifyPointer(isolate, wasm_to_js_wrapper_code__value);
    CHECK(wasm_to_js_wrapper_code__value.IsCode());
  }
  {
    Object serialized_return_count__value = TaggedField<Object>::load(o, 40);
    Object::VerifyPointer(isolate, serialized_return_count__value);
    CHECK(serialized_return_count__value.IsSmi());
  }
  {
    Object serialized_parameter_count__value = TaggedField<Object>::load(o, 48);
    Object::VerifyPointer(isolate, serialized_parameter_count__value);
    CHECK(serialized_parameter_count__value.IsSmi());
  }
  {
    Object serialized_signature__value = TaggedField<Object>::load(o, 56);
...
void TorqueGeneratedClassVerifiers::WasmModuleObjectVerify(WasmModuleObject o, Isolate* isolate) {
  ...
  {
    Object export_wrappers__value = TaggedField<Object>::load(o, 32);
...
void TorqueGeneratedClassVerifiers::WasmTableObjectVerify(WasmTableObject o, Isolate* isolate) {
  ...
  }
  {
    ...
    CHECK(maximum_length__value.IsUndefined() || maximum_length__value.IsHeapNumber() || maximum_length__value.IsSmi());
  }
  {
...
void TorqueGeneratedClassVerifiers::WasmMemoryObjectVerify(WasmMemoryObject o, Isolate* isolate) {
  ...
  {
    Object instances__value = TaggedField<Object>::load(o, 40);
...
void TorqueGeneratedClassVerifiers::AsmWasmDataVerify(AsmWasmData o, Isolate* isolate) {
  ...
  {
    Object export_wrappers__value = TaggedField<Object>::load(o, 16);
    Object::VerifyPointer(isolate, export_wrappers__value);
    CHECK(export_wrappers__value.IsFixedArray());
  }
  {
    Object uses_bitset__value = TaggedField<Object>::load(o, 24);
...
void TorqueGeneratedClassVerifiers::WasmTypeInfoVerify(WasmTypeInfo o, Isolate* isolate) {
  ...
  {
    Object supertypes__value = TaggedField<Object>::load(o, 16);
    Object::VerifyPointer(isolate, supertypes__value);
    CHECK(supertypes__value.IsFixedArray());
  }
  {
    Object subtypes__value = TaggedField<Object>::load(o, 24);
    Object::VerifyPointer(isolate, subtypes__value);
    CHECK(subtypes__value.IsArrayList());
  }
  {
    Object instance_size__value = TaggedField<Object>::load(o, 32);
    Object::VerifyPointer(isolate, instance_size__value);
    CHECK(instance_size__value.IsSmi());
  }
  {
    Object instance__value = TaggedField<Object>::load(o, 40);
    Object::VerifyPointer(isolate, instance__value);
    CHECK(instance__value.IsWasmInstanceObject());
  }
}
